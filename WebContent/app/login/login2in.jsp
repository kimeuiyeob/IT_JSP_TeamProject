		...
		<div class="kakao_main2">
			...
			<div class="kakao_menu1">
				...
				<div class="kakao_menu2">
					<form
						action="${pageContext.request.contextPath}/login/loginOk.indi"
						name="loginForm">
						<div class="phone_number">
							<input type="text" name="individualMemberId" id="phone_number"
								placeholder="아이디"
								value="${empty cookie.individualMemberId.value ? '': individualMemberId}">
						</div>
						<div class="password">
							<input type="password" name="individualMemberPassword"
								id="password" placeholder="비밀번호"
								value="${empty cookie.individualMemberPassword.value ? '': individualMemberPassword}">
						</div>
					...
					<div class="or">
						<fieldset
							...
							<legend style="text-align: center; font-size: 12px; color: grey;">또는</legend>
						</fieldset>
					</div>
					<div class="buttonWrap" style="position: relative;">
						<a href="${pageContext.request.contextPath}/login/join.indi">
					...
					<div class="signup_menu" style="position: relative">
						...
						<a href="${pageContext.request.contextPath}/find/findId.indi">
							<div class="find_id"
						...
						<div class="sorry"
							...
							|</div>
						<a href="${pageContext.request.contextPath}/find/findPw.indi">
...
<script>
	let id = "${cookie.individualMemberId.value}";
...
<script
	src="${pageContext.request.contextPath}/assets/js/login/login2in.js"></script>
