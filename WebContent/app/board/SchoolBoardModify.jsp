...
<body>
   ...
   <form action="${pageContext.request.contextPath}/board/boardUpateOk.schoolcom" name="writeForm" method="post">
         <!-- 커뮤니티 넘버 -->
             <input type="hidden" name="nurserySchoolCommunityNumber" value="${board.getNurserySchoolCommunityNumber()}"/>
         <!-- 제목 -->
         <input id="boardTitle" type="text" value="${board.getNurserySchoolCommunityTitle()}" name="nurserySchoolCommunityTitle"
         ...
         <div class="sc-e489b3e-9 iLCbOX" style="margin: 20px; margin-right: 14px;">
            <div class="sc-1f17b81e-1 fGEGPt postWrite">
               <textarea id="boardContent" class="sc-1f17b81e-0 dHJCuF sc-e489b3e-10 iTqZES  "
                 name="nurserySchoolCommunityContent" autocomplete="off">${board.getNurserySchoolCommunityContent()}</textarea>
            </div>
         </div>
