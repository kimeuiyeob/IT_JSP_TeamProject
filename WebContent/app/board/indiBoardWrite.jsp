...
<link rel="stylesheet"
   href="${pageContext.request.contextPath}/assets/css/board/inBoardWrite.css" />
</head>
...
<body>
   ...
   <div id="modifySchool" style="padding-right: 4px;">
      ...
      <header>
         <div id="headerBox">
            ...
            <div class="search_box">
               ...
               <img
                  src="${pageContext.request.contextPath}/assets/img/board/search.png">
            </div>
            <div class="user">
               <span> </span>
               ...
               <div id="userWrap">
                  ...
                  <span id="bottomPointer"
                     style="position: absolute; left: 96.4%; top: 13px"> <svg
      ...
      <div class="sc-e489b3e-3 gEAbaC"
         ...
         <div class="sc-e489b3e-7 dkxgGx"
            style="padding-right: 20px; margin-left: 22px;">
            ...
            <div md="Body2" class="sc-8ee9b8f2-0 gBPcnX sc-e489b3e-8 eaqXQT"
               style="font-size: 14px; letter-spacing: -1px; padding-right: 394px;">춤추는
               처키</div>
            ...
            <div style="display: flex;">
               <div class="image-upload">
                  ...
                  </label> <input id="file-input" type="file" style="display: none;" />
               </div>

               <span></span>
            </div>
            <!--     <div>
                    <img src="img/putpicture.png" style="height : 43px ; cursor: pointer;">
                </div> -->
         </div>
      </div>
      ...
      <input id="boardTitle" placeholder="제목을 입력하세요" name="content"
         autocomplete="off" style="padding: 16px; margin: 20px 20px 0 20px; width: 605px; height: 20px">
      <div class="sc-e489b3e-9 iLCbOX"
         style="margin: 20px; margin-right: 14px;">
         <div class="sc-1f17b81e-1 fGEGPt">
            <textarea class="sc-1f17b81e-0 dHJCuF sc-e489b3e-10 iTqZES  "
               placeholder="무단 홍보, 비방 글은 삭제될 수 있습니다." name="content"
               autocomplete="off"></textarea>
         </div>
      </div>
      <!-- 첨부파일 이름은 #fileName에 넣으세요 -->
      <div id="attachedFile" style="padding: 0 20px 0 20px; color:rgb(190 190 190)">첨부된 파일: <span id="fileName"></span></div> 
   </div>
   ...
   <div id="withdrawal">
      <div id="content2" style="margin-top: -20px;">
         <div id="first">
            <button class="withdrawalSubmit" id="save" type="submit"
...
<script
   src="${pageContext.request.contextPath}/assets/js/board/inBoardWrite.js"></script>
</body>
</html>