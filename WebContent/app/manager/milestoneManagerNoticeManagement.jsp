        ...
        <div class="main">
            <div id="toolbar">
                <div id="toolbarTitle">
                    ...
                    <span id="toolbarTitleSub">홈 - 공지사항 - 공지사항 관리</span>
                </div>
            </div>
            <!-- 메인 컨텐츠 -->
                                ...
                                <tbody class="card-body-main-box">
                                    <tr>
                                        <th class="card-body-title-checkbox-padding" style="width: 4%;">
                                            <label class="card-body-title-user-checkbox">
                                                <div class="check-img"></div>
                                                <input class="notice-checked" type="checkbox" name="check" value = "${notice.getNoticeNumber()}"  onclick='check(event)'/>
                                            </label>
                                        </th>
                                        <th class="card-body-title-padding" style="width: 6%;">
...
<script src="${pageContext.request.contextPath}/assets/js/manager/mileStoneManager_noticeManagement.js"></script>
<script>
