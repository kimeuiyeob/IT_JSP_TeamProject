...
<body onload="showClock()">
	...
	<main>
		<div class="main">
			<div id="toolbar">
				<div id="toolbarTitle">
					<span id="toolbarTitleText">기부 내역</span> <span id="toolbarTitleSub">홈
						- 대시보드 -기부 내역</span>
				</div>
			</div>
			<!-- 메인 컨텐츠 -->
													...
													<div class="menu-sub-dropdown-option">
														<label class="menu-sub-dropdown-option-box"> <input
															...
															<div class="menu-sub-dropdown-option-sub">
																<div class="menu-sub-dropdown-option-sub-item">음식
																</div>
																<div class="menu-sub-dropdown-option-sub-item">
																	생필품</div>
																<div class="menu-sub-dropdown-option-sub-item">가구
																</div>
																<div class="menu-sub-dropdown-option-sub-item">
																	기부금</div>
																<div class="menu-sub-dropdown-option-sub-item">기타
																</div>
															</div>
														</label>
													</div>
						...
						<div class="card-body">
							...
							<table>
								...
								<c:choose>
									...
									<c:otherwise>
										<tr>
											<td colspan="5" align="center">기부 내역이 없습니다.</td>
										</tr>
									</c:otherwise>
								</c:choose>
							</table>
								...
								<tr align="center" valign="middle">
									<td class="web-view"><c:if test="${prev}">
											<a style="text-decoration:none; color:black"
												href="${pageContext.request.contextPath}/management/managerDonateHistory.don?page=${startPage - 1}">&lt;</a>
										</c:if> <c:forEach var="i" begin="${startPage}" end="${endPage}">
											<c:choose>
												<c:when test="${not (i eq page)}">
													<a style="text-decoration:none; color:black"
														href="${pageContext.request.contextPath}/management/managerDonateHistory.don?page=${i}">
														<c:out value="${i}" />&nbsp;&nbsp;
													</a>
												</c:when>
												<c:otherwise>
											...
											<a style="text-decoration:none; color:black"
												href="${pageContext.request.contextPath}/management/managerDonateHistory.don?page=${endPage + 1}">&gt;</a>
										</c:if></td>
								</tr>
							</table>
						</div>
