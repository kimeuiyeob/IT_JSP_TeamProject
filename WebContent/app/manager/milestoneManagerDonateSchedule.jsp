...
<head>
    ...
    <link href='${pageContext.request.contextPath}/assets/css/manager/main.css' rel='stylesheet' />
...
<body onload="showClock()">
    ...
    <main>
        <div class="main">
            <div id="toolbar">
                <div id="toolbarTitle">
                    <span id="toolbarTitleText">기부 일정 달력</span>
                    <span id="toolbarTitleSub">홈 - 기부 일정 관리 - 기부 일정 달력</span>
                </div>
            </div>
            <!-- 메인 컨텐츠 -->
...
<script src="${pageContext.request.contextPath}/assets/js/manager/mileStoneManager_donateSchedule.js"></script>
<script src='${pageContext.request.contextPath}/assets/js/manager/main.js'></script>
