...
<body onload="showClock()">
    ...
    <main>
        <div class="main">
            <div id="toolbar">
                <div id="toolbarTitle">
                    <span id="toolbarTitleText">게시글 목록</span>
                    <span id="toolbarTitleSub">홈 - 커뮤니티 관리 - 게시글 목록</span>
                </div>
            </div>
            <!-- 메인 컨텐츠 -->
                            ...
                            <table>
                                <thead class="card-body-title-box">
                                    <tr class="card-body-line">
                                        <th class="card-body-title-checkbox-padding" style="width: 4%;">
...
<script src="${pageContext.request.contextPath}/assets/js/manager/mileStoneManager_community.js"></script>
