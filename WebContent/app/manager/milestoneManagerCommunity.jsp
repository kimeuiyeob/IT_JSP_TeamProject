...
<body onload="showClock()">
			...
			<div id="sidebar_menu_wrapper">
				<div class="menu menu_colum">
					...
					<div class="menu_item">
						...
						<div class="menu-sub" onclick="javascript:btn()">
							<div class="menu-item">
								<a class="menu-link active" href=""> <span
									class="menu-bullet"> <span class="bullet"></span>
	...
	<main>
		<div class="main">
			<div id="toolbar">
				<div id="toolbarTitle">
					<span id="toolbarTitleText">게시글 목록</span> <span
						id="toolbarTitleSub">홈 - 커뮤니티 관리 - 게시글 목록</span>
				</div>
			</div>
			<!-- 메인 컨텐츠 -->
											...
											<div class="menu-sub-dropdown-wrap">
												<div class="menu-sub-dropdown-item-margin">
													<div class="menu-sub-dropdown-item-title-margin">
														<div class="menu-sub-dropdown-item-title">조회순:</div>
													</div>
												...
												<div class="menu-sub-dropdown-item-margin">
													<div class="menu-sub-dropdown-item-title-margin">
														<div class="menu-sub-dropdown-item-title">댓글순:</div>
													</div>
													<div class="menu-sub-dropdown-option">
														<label class="menu-sub-dropdown-option-box"> <input
															type="checkbox">
								...
								<thead class="card-body-title-box">
									<tr class="card-body-line">
										...
										<th class="card-body-title-padding" style="width: 22%;">
											<div class="card-body-title-height">작성자</div>
										</th>
										<th class="card-body-title-padding" style="width: 29%;">
											<div class="card-body-title-height">게시글 제목</div>
										</th>
										<th class="card-body-title-padding" style="width: 10%;">
											<div class="card-body-title-height">조회수</div>
										</th>
													...
													<th class="card-body-title-padding" style="width: 22%;">
														<div class="donater-info">
															...
															<div class="donater-info-text">
																...
																<div>
																	<c:out value="${individual.getIndividualMemberEmail()}" />
																</div>
															</div>
														</div>
													</th>
													<th class="card-body-title-padding" style="width: 29%;">
														<div class="donate-info-height">
															<div class="donate-info-text">
																<c:out
																	value="${individual.getIndividualCommunityTitle()}" />
															</div>
														</div>
													</th>
													<th class="card-body-title-padding" style="width: 10%;">
														<div class="donate-info-height">
															<c:out value="${individual.getIndividualCommunityHits()}" />
														</div>
													</th>
													<th class="card-body-title-padding" style="width: 25%;">
														<div class="donate-info-height">
															<c:out
																value="${individual.getIndividualCommunityDateCreated()}" />
														</div>
													</th>
											</c:forEach>
										</c:when>
...
<script
	src="${pageContext.request.contextPath}/assets/js/manager/mileStoneManager_community.js"></script>
<script>
	function btn() {
		alert('준비중입니다.');
	}
