			...
			<div class="login_menu1">
				...
				<div class="login_menu2">
					...
					<div class="login_hello" style="padding-top: 150px;">
						...
						<h1 style="font-family: 'Pretendard JP'; letter-spacing: -1.5px;">개인
							회원가입</h1>

					</div>
					<!-- 여기 -->
					<form method="post"
						action="${pageContext.request.contextPath}/login/joinOk.indi"
						name="joinForm">
						...
						<div style="padding-bottom: 15px">
							<input class="inputWrap" name="individualMemberName" type="text"
								value="" placeholder="성명">
							<div style="color: red; font-size: 10px;"
								id="individualMemberNamediv" value=""></div>
						</div>
						...
						<div style="padding-bottom: 15px">
							<input class="inputWrap" name="nickName" type="text" value=""
								placeholder="닉네임">
							<div style="color: red; font-size: 10px;" id="nickNamediv"
								value=""></div>
						</div>
						...
						<div style="padding-bottom: 15px">
							<input class="inputWrap" type="text" value=""
								placeholder="01012345678" name="individualMemberPhoneNumber">
							<div style="color: red; font-size: 10px;"
								id="individualMemberPhoneNumberdiv" value=""></div>
						</div>
						...
						<div style="padding-bottom: 15px">
							<input class="inputWrap" type="text" value="" placeholder="아이디"
								name="individualMemberId">
							<div style="color: red; font-size: 10px;"
								id="individualMemberIddiv" value=""></div>
						</div>
						...
						<input type="text" name="individualMemberAddress"
							class="inputWrap" placeholder="주소">
						<div style="color: red; font-size: 10px;"
							id="individualMemberAddressdiv" value=""></div>
						<div>
							<br>
						</div>
						<input type="text" name="individualMemberDetailedAddress"
							class="inputWrap" placeholder="상세주소">
						<div style="color: red; font-size: 10px;"
							id="individualMemberDetailedAddressdiv" value=""></div>
						...
						<div style="padding-bottom: 15px;">
							<input class="inputWrap" name="individualMemberPassword"
								type="password" value="" placeholder="********">
							<div style="color: red; font-size: 10px;"
								id="individualMemberPassworddiv" value=""></div>
							...
							<div style="color: red; font-size: 10px;" id="passdiv" value=""></div>
							<div style="padding-top: 15px;">
								<h5>비밀번호 확인</h5>
							</div style="padding-bottom : 15px">
							<input class="inputWrap" name="individualMemberPassword2"
								type="password" value="" placeholder="********">
							<div style="color: red; font-size: 10px;"
								id="individualMemberPassworddiv2" value=""></div>
						</div>
						...
						<div style="padding-bottom: 25px">
							<div class="flex">
								<input class="inputWrap" id="email" name="individualMemberEmail"
									type="text" value="" placeholder="example@naver.com"> <input
									type="button" id="email_input" value="인증번호 받기"
									onclick="sendEmail()">
							</div>
							<br> <input type="text" name="checkIndividualMemberEmail"
								class="inputWrap" placeholder="인증번호 입력">
							<div style="color: red; font-size: 10px;"
								id="individualMemberEmaildiv" value=""></div>
							<div style="color: red; font-size: 10px;"
								id="checkIndividualMemberEmaildiv" value=""></div>
						</div>
...
<script
	src="${pageContext.request.contextPath}/assets/js/join/signupIn.js"></script>
<!-- 아임포트 api -->
...
<script type="text/javascript">
	...
	function naverSignInCallback() {
		...
		$('input[name = "individualMemberName"]').val(name);
