   ...
   <div id="modifySchool">
      ...
      <header>
         ...
         <div id="headerBox">
            ...
            <div class="logo">
               ...
               <img
                  src="${pageContext.request.contextPath}/assets/img/schoolMyPage/logo.png">
            ...
            <div class="search_box">
               ...
               <input id="searchInput" type="text" placeholder="정을 옮기는 이정표입니다"><img
                  src="${pageContext.request.contextPath}/assets/img/schoolMyPage/search.png">
               ...
               <div id="miniBox2">
                  ...
                  <div id="miniBox3">
                     ...
                     <div id="miniProfile">
                        ...
                        <div style="margin: 10px;">
                           ...
                           <div id="miniProfileRight">
                              <a
                                 href="${pageContext.request.contextPath}/app/schoolMyPage/scDh.jsp"
                     ...
                     <div style="text-align: center; cursor: pointer;"
                        onclick="location.href = '${pageContext.request.contextPath}/app/main/main.jsp'">로그아웃</div>
      ...
      <div id="content">
         ...
         <div id="category">
            ...
            <div id="smallHistory">보육원 정보 수정</div>
         ...
         <form action="">
            ...
            <div class="content">
               ...
               <div class="inputContent">보육원 이름</div>
            ...
            <div style="display: flex;">
               ...
               <div class="inputContent"
                  style="display: flex; align-items: center; width: 82%;">사진을
                  첨부하여 소개글을 작성하세요!</div>

               <div class="image-upload">

                  <label for="file-input"> <img
                     src="${pageContext.request.contextPath}/assets/img/schoolMyPage/putpicture.png"
            ...
            <div class="sc-e489b3e-9 iLCbOX" style="border-radius: 3px;">
         ...
         <div class="modal_body" style="display: hidden;">
            ...
            <div class="wrap">
               ...
               <div id="ask" style="cursor: pointer;">
                  <a
                     href="${pageContext.request.contextPath}/app/faq/faq.jsp"
...
<script
   src="${pageContext.request.contextPath}/assets/js/MyPage/scmodify.js"></script>
