      ...
      <main>
         ...
         <section id="myPageSection">
            ...
            <div id="donationHistory">
               <div class="dhTitle"
                  style="font-size: 18px; font-weight: bolder; color: rgb(26, 26, 26); line-height: 24px; letter-spacing: -0.45px;">기부받은
                  내역</div>
               <div class="dhList">
                  <img
                  ...
                  <div id="left">
                     <div>2022.10.01</div>
                     <div
                        style="color: rgb(253, 126, 20); font-size: 13px; font-weight: 600;">김팀장</div>
                  </div>
                  <div id="rightButton">
                     1,000,000
                     <div id="won">원</div>
               ...
               <div class="dhList">
                  ...
                  <div id="left">
                     <div>2022.10.01</div>
                     <div
                        style="color: rgb(253, 126, 20); font-size: 13px; font-weight: 600;">부팀장짱</div>
                  </div>
                  <div id="rightButton">
                     1,000,000
                     <div id="won">원</div>
               ...
               <div class="dhList">
                  ...
                  <div id="left">
                     <div>2022.10.01</div>
                     <div
                        style="color: rgb(253, 126, 20); font-size: 13px; font-weight: 600;">황지수와아이들</div>
                  </div>
               ...
               <div class="dhList">
                  ...
                  <div id="left">
                     <div>2022.10.01</div>
                     <div
                        style="color: rgb(253, 126, 20); font-size: 13px; font-weight: 600;">닉네임소재a</div>
                  </div>
               ...
               <div class="dhList">
                  ...
                  <div id="left">
                     <div>2022.10.01</div>
                     <div
                        style="color: rgb(253, 126, 20); font-size: 13px; font-weight: 600;">떨어져간다123</div>
                  </div>
               ...
               <div class="dhList">
                  ...
                  <div id="left">
                     <div>2022.10.01</div>
                     <div
                        style="color: rgb(253, 126, 20); font-size: 13px; font-weight: 600;">개발상팔</div>
                  </div>
                  <div id="rightButton">
                     3,000,000
                     <div id="won">원</div>
               ...
               <div class="dhList">
                  ...
                  <div id="left">
                     <div>2022.10.01</div>
                     <div
                        style="color: rgb(253, 126, 20); font-size: 13px; font-weight: 600;">4팀짱</div>
                  </div>
                  <div id="rightButton">
                     500,000
                     <div id="won">원</div>
