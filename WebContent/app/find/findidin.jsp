		...
		<div class="the-main">
			...
			<div class="box-1">
				...
				<div class="box-2">
					...
					<form action="${pageContext.request.contextPath}/find/findIdResult.indi" name = "resultForm">
					 	<input type = hidden name = "individualMemberId" value = "">
						<div class="phone_number" style="padding-bottom: 5px;">
							<input type="text" name="individualMemberName" id="phone_number"
								placeholder="성명">
						</div>

						<div class="phone_number">
							<input type="text" name="individualMemberPhoneNumber"
								id="phone_number" placeholder="전화번호">
						</div>
					</form>
...
<script
	src="${pageContext.request.contextPath}/assets/js/find/findIdIn.js"></script>
</html>