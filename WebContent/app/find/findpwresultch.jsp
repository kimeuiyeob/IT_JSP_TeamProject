		...
		<div class="the-main">
			...
			<div class="box-1">
				...
				<div class="box-2">
					...
					<form
						action="${pageContext.request.contextPath}/find/updatePw.school"
						name="updateForm">
						<input type=hidden name="nurserySchoolMemberNumber"
							value="${param.nurserySchoolMemberNumber}">
						<div class="phone_number" style="padding-top: 20px">
							<input type="text" name="nurserySchoolMemberPassword" id="phone_number" placeholder="비밀번호">
							<div style="color: red; font-size: 10px;" id="passdiv" value=""></div>
						</div>
					</form>

					<div class="phone_number2">
						<input type="text" name="checkNurserySchoolMemberPassword" id="phone_number2"
							placeholder="비밀번호 확인">
						<div style="color: red; font-size: 10px;" id="passdiv2" value=""></div>
					</div>
...
<script
	src="${pageContext.request.contextPath}/assets/js/find/updatePwSc.js"></script>
