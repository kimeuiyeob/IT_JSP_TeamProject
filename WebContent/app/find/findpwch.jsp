		...
		<div class="the-main">
			...
			<div class="box-1">
				...
				<div class="box-2">
					...
					<form
						action="${pageContext.request.contextPath}/find/findPwResult.school"
						name="resultForm">
						<input type=hidden name="nurserySchoolMemberNumber" value="">
						...
						<div class="name">
							<input type="text" name="nurserySchoolMemberPhoneNumber"
								id="name" placeholder="전화번호">
						</div>
					</form>
...
<script
	src="${pageContext.request.contextPath}/assets/js/find/findPwSc.js"></script>
</html>